...
describe('redux: flashMessage', function () {
  ...
  describe('deleteFlashMessage', function () {
    it('should delete a flash message based on its id', function () {
      var state = (0, _flashMessage2.default)({ flashMessages: [{ id: '123', messageType: 'success', messageText: 'keep' }, { id: '456', messageType: 'error', messageText: 'be gone' }] }, (0, _flashMessage.deleteFlashMessage)('456'));
  ...
  describe('clearAllFlashMessages', function () {
    it('should reset state.flashMessages to its default state of null', function () {
      var state = (0, _flashMessage2.default)({ flashMessages: [{ id: '123', messageType: 'success', messageText: 'keep' }, { id: '456', messageType: 'error', messageText: 'be gone' }] }, (0, _flashMessage.clearAllFlashMessages)());
      expect(state).toEqual(_flashMessage.DEFAULT_STATE);
    });
  });
